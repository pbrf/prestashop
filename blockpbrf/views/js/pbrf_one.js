...
jQuery(document).ready(function () {
    ...
    jQuery('div.button-command>a').after('&nbsp;&nbsp;&nbsp;<input type="button" class="pbrf_button" name="pbrf" title="Распечатать бланки Почты России" onclick="jQuery(\'#cen\').val(\'' + order_total + '\');jQuery(\'#nalojka\').val(\'' + order_total + '\');jQuery(\'#span_pbrf\').html(\'Заказ № ' + id_order + '\');jQuery(\'#pbrf_order_id\').val(' + id_order + ');jQuery(\'#PbrfMessage\').fadeIn();" /> ');
